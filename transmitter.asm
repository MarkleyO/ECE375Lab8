...
USART_Transmit_halt:
  lds mpr, UCSR1A ; Loop until UDR1 is empty
  sbrs mpr, UDRE1
  rjmp USART_Transmit_halt
  ldi  data, robotID
  sts UDR1, data ; Move data to transmit data buffer

//Transmit move code
USART_Transmit_halt2:
  lds mpr, UCSR1A ; Loop until UDR1 is empty
  sbrs mpr, UDRE1
  rjmp USART_Transmit_halt2
  ldi  data, Halt
  sts UDR1, data ; Move data to transmit data buffer
ret
...
//Transmit robotid
USART_Transmit_freeze:
  lds mpr, UCSR1A ; Loop until UDR1 is empty
  sbrs mpr, UDRE1
  rjmp USART_Transmit_freeze
  ldi  data, robotID
  sts UDR1, data ; Move data to transmit data buffer

//Transmit move code
USART_Transmit_freeze2:
  lds mpr, UCSR1A ; Loop until UDR1 is empty
  sbrs mpr, UDRE1
  rjmp USART_Transmit_freeze2
  ldi  data, Freeze
  sts UDR1, data ; Move data to transmit data buffer
ret
